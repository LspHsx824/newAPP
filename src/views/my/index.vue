<template>
    <div class="page-content">
        ...
        <div class="black-1">
            ...
            <div class="desc" :style="{ width: '7rem' }">{{ $t("home_top.briefcontent") }}</div>
            <div class="price">
                <img src="@/static/newImg/logo.c9ddff00.png" :style="{ marginTop: '35px' }" alt />
                <div class="key" :style="{ marginTop: '35px' }">{{ $t("home_top.homeT_price") }}</div>
                <div class="val" :style="{ marginTop: '35px' }">$ {{ Curslt1n_price }}</div>
            </div>
        </div>
            ...
            >
                <van-swipe-item v-for="(item, i) in dataList" :key="i">
                    ...
                    <div
                        class="btn-swipe"
                        @click="show_buy(++i)"
                    >{{ $t("home_top.homeBto_participate") }}</div>
                </van-swipe-item>
            </van-swipe>
        </div>
        ...
        async handle_toast() {
            if ([1, 7].includes(this.activeIndex)) {
                ...
                try {
                    ...
                    await BuyNFT(this.dataList[activeIndex - 1].num);
